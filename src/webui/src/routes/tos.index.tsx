        ...
        <main className="min-h-svh bg-background px-6 py-12">
            <article className="prose prose-sm mx-auto dark:prose-invert sm:prose-base">
                ...
                <p>Please read these terms and conditions carefully before using Our Service.</p>
                    ...
                    <ul>
                        ...
                        <li>
                            <p>
                                ...
                                the entire agreement between You and Us regarding the use of the Service.
                            </p>
                        </li>
                        <li>
                            <p>
                        ...
                        <li>
                            <p>
                                <strong>You</strong> means the individual accessing or using the Service, or Us, or other legal entity on behalf of
                    ...
                    <p>
                        You represent that you are over the age of 18 or the age of majority where You currently reside in. We do not permit those
                        under 18 or the age of majority where You currently reside in to use the Service.
                    </p>
                    <p>
                        ...
                        Ours. Our Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your personal
                    ...
                    <p>
                        ...
                        any damage or loss caused or alleged to be caused by or in connection with the use of or reliance on any such content, goods
                    ...
                    <p>
                        ...
                        data or other information, for business interruption, for personal injury, loss of privacy arising out of or in any way
                        ...
                        or otherwise in connection with any provision of this Terms), even if We or any supplier has been advised of the possibility
                    ...
                    <p>
                        ...
                        of any kind. To the maximum extent permitted under applicable law, We, on our own behalf and on behalf of our Affiliates and
                        our and their respective licensors and service providers, expressly disclaim all warranties, whether express, implied,
                        ...
                        usage or trade practice. Without limitation to the foregoing, We provide no warranty or undertaking, and make no
                    ...
                    <p>
                        Without limiting the foregoing, neither We nor any of Our providers makes any representation or warranty of any kind, express
                        or implied: (i) as to the operation or availability of the Service, or the information, content, and materials or products
                        included thereon; (ii) that the Service will be uninterrupted or error-free; (iii) as to the accuracy, reliability, or
                        currency of any information or content provided through the Service; or (iv) that the Service, its servers, the content, or
                        e-mails sent from or on behalf of Us are free of viruses, scripts, trojan horses, worms, malware, timebombs or other harmful
                        components.
                    </p>
                    <p>
                        Some jurisdictions do not allow the exclusion of certain types of warranties or limitations on applicable statutory rights of
                        a consumer, so some or all of the above exclusions and limitations may not apply to You. But in such a case the exclusions and
                    ...
                    <h3>Waiver</h3>
                    <p>
                        Except as provided herein, the failure to exercise a right or to require performance of an obligation under these Terms shall
                        not affect a party's ability to exercise such right or require such performance at any time thereafter nor shall the waiver of
                    ...
                    <p>
                        ...
                        make reasonable efforts to provide at least 30 days' notice prior to any new terms taking effect. What constitutes a material
