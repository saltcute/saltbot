    ...
    return (
        <main className="min-h-svh bg-background px-6 py-12">
            <article className="prose prose-sm mx-auto dark:prose-invert sm:prose-base">
                ...
                <p className="text-center text-muted-foreground">Last updated: July 07, 2025</p>
                ...
                <ul>
                    ...
                    <li>
                        <p>
                            <strong>Application</strong> refers to saltbot, the Discord bot provided by Us.
                        </p>
                    </li>
                    <li>
                        <p>
                    ...
                    <li>
                        <p>
                            <strong>Service</strong> refers the Application.
                        </p>
                    </li>
                    <li>
                        <p>
                            <strong>Terms and Conditions</strong> (also referred as &quot;Terms&quot;) mean these Terms and Conditions that form the
                            entire agreement between You and Us regarding the use of the Service.
                        </p>
                    </li>
                    <li>
                        <p>
                            <strong>We</strong> (also referred to as either &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Ionic
                            Compound.
                        </p>
                    </li>
                    <li>
                        <p>
                            <strong>You</strong> means the individual accessing or using the Service, or Us, or other legal entity on behalf of which
                ...
                <p>
                    These are the Terms and Conditions governing the use of this Service and the agreement that operates between You and Us. These
                ...
                <p>
                    You represent that you are over the age of 18 or the age of majority where You currently reside in. We do not permit those under
                    18 or the age of majority where You currently reside in to use the Service.
                </p>
                <p>
                    Your access to and use of the Service is also conditioned on Your acceptance of and compliance with the Privacy Policy of Ours.
                    ...
                    You use the Application or the Website and tells You about Your privacy rights and how the law protects You. Please read Our
                ...
                <p>
                    ...
                    sites or services. You further acknowledge and agree that We shall not be responsible or liable, directly or indirectly, for any
                ...
                <p>
                    Notwithstanding any damages that You might incur, the entire liability of Ours and any of its suppliers under any provision of
                ...
                <p>
                    To the maximum extent permitted by applicable law, in no event shall We or our suppliers be liable for any special, incidental,
                    ...
                    inability to use the Service, third-party software and/or third-party hardware used with the Service, or otherwise in connection
                    with any provision of this Terms), even if We or any supplier has been advised of the possibility of such damages and even if the
                ...
                <p>
                    ...
                    any kind. To the maximum extent permitted under applicable law, We, on our own behalf and on behalf of our Affiliates and our and
                    their respective licensors and service providers, expressly disclaim all warranties, whether express, implied, statutory or
                    otherwise, with respect to the Service, including all implied warranties of merchantability, fitness for a particular purpose,
                    title and non-infringement, and warranties that may arise out of course of dealing, course of performance, usage or trade
                    practice. Without limitation to the foregoing, We provide no warranty or undertaking, and make no representation of any kind that
                    the Service will meet Your requirements, achieve any intended results, be compatible or work with any other software,
                ...
                <p>
                    Without limiting the foregoing, neither We nor any of Our providers makes any representation or warranty of any kind, express or
                    ...
                    on behalf of Us are free of viruses, scripts, trojan horses, worms, malware, timebombs or other harmful components.
                </p>
                <p>
                ...
                <p>
                    You represent and warrant that (i) You are not located in a country that is subject to the United States government embargo, or
                    that has been designated by the United States government as a &quot;terrorist supporting&quot; country, and (ii) You are not
                ...
                <p>
                    ...
                    affect a party's ability to exercise such right or require such performance at any time thereafter nor shall the waiver of a
                ...
                <p>
                    ...
                    You do not agree to the new terms, in whole or in part, please stop using the website and the Service.
                </p>
                <h2>Contact Us</h2>
                <p>If you have any questions about these Terms and Conditions, You can contact us:</p>
                <ul>
                    <li>
                        By email: <ContactEmail hostname={hostname} />
                    </li>
                </ul>
            </article>
        </main>
