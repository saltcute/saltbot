        ...
        <main className="min-h-svh bg-background px-6 py-12">
            <article className="prose prose-sm mx-auto dark:prose-invert sm:prose-base">
                ...
                <ul>
                    ...
                    <li>
                        <p>
                            <strong>Service Provider</strong> means any natural or legal person who processes the data on behalf of Us. It refers to
                            third-party companies or individuals employed by Us to facilitate the Service, to provide the Service on behalf of Us, to
                            perform services related to the Service or to assist Us in analyzing how the Service is used.
                        </p>
                    </li>
                    <li>
                        <p>
                ...
                <ul>
                    ...
                    <li>
                        <p>
                            ...
                            concern or as part of bankruptcy, liquidation, or similar proceeding, in which Personal Data held by Us about our Service
                    ...
                    <li>
                        <p>
                            ...
                            usage trends, determining the effectiveness of our promotional campaigns and to evaluate and improve our Service,
                ...
                <ul>
                    ...
                    <li>
                        ...
                        users, such information may be viewed by all users and may be publicly distributed outside. If You interact with other users
                ...
                <p>
                    Your information, including Personal Data, is processed at Our operating offices and in any other places where the parties
                    involved in the processing are located. It means that this information may be transferred to — and maintained on — computers
                ...
                <p>
                    We will take all steps reasonably necessary to ensure that Your data is treated securely and in accordance with this Privacy
                ...
                <p>
                    If We are involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before
                    Your Personal Data is transferred and becomes subject to a different Privacy Policy.
                </p>
                <h4>Law enforcement</h4>
                <p>
                    Under certain circumstances, We may be required to disclose Your Personal Data if required to do so by law or in response to valid
